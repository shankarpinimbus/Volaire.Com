...
namespace CSWeb
{
    public class OrderHelper
    {
            ...
            if (emailTemplate.Body != null)
            {
                ...
                foreach (XElement node in nodes)
                {
                    ...
                    for (int i = 0; i < totalSkuItems; i++)
                    {
                        ...
                        if (sku.SkuId != 153 && sku.SkuId != 154)
                        {
        ...
        public static bool AutoshipCart()
        {
        ...
        public static void MobileRedirect()
        {
            ...
            if (!version.ToLower().Contains("mobile"))
            {
                ...
                if (version.ToLower().Contains("d2"))
                {
                    RedirectVersion = "mobile_d2";
                }
                if (version.ToLower().Contains("e2"))
                {
                    RedirectVersion = "mobile_e2";
                }
                if (version.ToLower().Contains("e3"))
                {
                ...
                if (version.ToLower().Contains("g2"))
                {
                    RedirectVersion = "mobile_g2";
                }
                if (version.ToLower().Contains("h2"))
                {
                ...
                if (version.ToLower().Contains("jj2"))
                {
                    RedirectVersion = "mobile_jj2";
                }
                if (version.ToLower().Contains("j2"))
                {
        ...
        public static void RedirectDesktop()
        {
            ...
            if (HttpContext.Current.Request.Url.ToString().ToLower().Contains("getvolaire"))
            {
                if (!version.Equals("get_aa1") && !version.Equals("get_a1"))
                {
                    if (HttpContext.Current.Request.QueryString.Count > 0)
                        HttpContext.Current.Response.Redirect("/get_a1/index?" + HttpContext.Current.Request.QueryString);
                    else
                    {
                        HttpContext.Current.Response.Redirect("/get_a1/index");
                    }
                }
            }
            else
            {
                ...
                if (version.Equals("aa1") || version.Equals("ee2"))
                {
                    if (HttpContext.Current.Request.QueryString.Count > 0)
                        HttpContext.Current.Response.Redirect("/jj2/index?" + HttpContext.Current.Request.QueryString);
                    else
                    {
                        HttpContext.Current.Response.Redirect("/jj2/index");
                    }
                }
            }
        ...
        public static void RedirectMobile()
        {
            ...
            if (HttpContext.Current.Request.Url.ToString().ToLower().Contains("getvolaire"))
            {
                if (!version.Equals("get_mobile_aa1") && !version.Equals("get_mobile_a1"))
                {
                    if (HttpContext.Current.Request.QueryString.Count > 0)
                        HttpContext.Current.Response.Redirect("/get_mobile_a1/index?" + HttpContext.Current.Request.QueryString);
                    else
                    {
                        HttpContext.Current.Response.Redirect("/get_mobile_a1/index");
                    }
                }
            }
            else
            {
                ...
                {
                    if (HttpContext.Current.Request.QueryString.Count > 0)
                        HttpContext.Current.Response.Redirect("/mobile_jj2/index?" + HttpContext.Current.Request.QueryString);
                    else
                    {
                        HttpContext.Current.Response.Redirect("/mobile_jj2/index");
                    }
                }
            }
