<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="/Desktop/mega-volume-collection.aspx.cs" Inherits="CSWeb.Desktop.megavolumecollection" EnableSessionState="True" %>
...
<body id="kit_90day" class="h2 h2-mega-offer">
...
<section class="container offer-content offer-30-day-kit clearfix">
    <div class="offer-left">
        ...
        <div class="offer-links">
            <h3>The 3-Piece, 90 Day Mega Volume<br />
    ...
    <div class="offer-right">
        <div class="text-center"><img src="//d39hwjxo88pg52.cloudfront.net/volaire/images/offer-mega-volume-collection.png" alt="Volaire Mega Volume Collection" class="offer-90-day-kit-img" /></div>
        ...
        <img src="//d39hwjxo88pg52.cloudfront.net/volaire/images/VOLAIRE-60DMBG.png" alt="60 Day Money Back Guarantee" class="iblock offer-mbg" style="margin-top: 1rem; margin-left: 1%;" />
        </div>
    </div>
</section>
