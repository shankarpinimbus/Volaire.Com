...
<%@ Register Src="~/Shared/UserControls/ShoppingCartControl_MOBILE.ascx" TagName="ShoppingCartControl" TagPrefix="uc" %>
        ...
        <div class="cart_content_B clearfix">
            ...
            <div class="cartB">
                <asp:Panel ID="pnlBillingInfo" runat="server" Visible="true">
                    <p class="required-txt">* All Fields Required</p>
                    ...
                    <div class="form_line clearfix">
                        ...
                        <label class="label-1">
                            Email Address*</label>
                        <asp:TextBox ID="txtEmail" required="required" runat="server" MaxLength="100" CssClass="text-1" placeholder="Email Address*"></asp:TextBox>
                ...
                <asp:Panel ID="pnlShippingAddress" runat="server" Visible="false">
                    ...
                    <div class="form_line clearfix">
                        ...
                        <input required="required" id="txtAddress1" runat="server" maxlength="30" clientidmode="Static" class="text-1 billingad1" placeholder="Address 1*" type="text" />
                    </div>
                    <div class="form_line clearfix">
                        <label class="label-1">
                            Address 2
                ...
                <asp:Panel runat="server" ID="pnlCreditCard" Visible="False">
                    ...
                    <div class="form_line clearfix">
                        ...
                        <asp:TextBox ID="txtNameOnCard" runat="server" required="required" CssClass="text-1" MaxLength="50" placeholder="Name on Card*"></asp:TextBox>
                    </div>
                    ...
                    <div class="form_line clearfix">
                        ...
                        <select name="ddlExpMonth" required="required" id="ddlExpMonth" clientidmode="Static" runat="server" class="text-1 text-2a">
                        </select>
...
<div id="pop-terms" class="legal" style="display: none;">
    <div class="overlay_content">
        <div class="txt-closex">
            <a href="javascript:void(0);" onclick="$.fancybox.close();">X</a>
        </div>
