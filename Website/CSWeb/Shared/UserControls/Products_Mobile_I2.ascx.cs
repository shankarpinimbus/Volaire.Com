...
{
    public partial class Products_Mobile_I2 : System.Web.UI.UserControl
    {
        ...
        private void PopulateSkuListing(int skucategory)
        {
            ...
            rptProducts3.DataSource = skus.Where(x => x.SkuId == 149 || x.SkuId == 150 || x.SkuId == 161 || x.SkuId == 151);
                ...
                case "ViewProduct":
                    {
                        ...
                        if (skuId == 161)
                        {
                            Response.Redirect(product_anchor3a.PostBackUrl);
                        }
                        else
                        {
                            if (Session["ClientOrderData"] == null)
