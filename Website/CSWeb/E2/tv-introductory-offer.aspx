    ...
    <div class="container3 clearfix order_kits_wrap">
            <div class="order-page-1-col-1 kit_box kit_box_mega kb_active ">
                <div class="">
                    ...
                    <a href="#" class="prodlink"><img src="//d39hwjxo88pg52.cloudfront.net/volaire/images/e2/selector-mega.jpg" class="full block" alt="Eight products for amazing skin. Get a skin care system that works for you and your skin. All shades of skin will benefit." /></a>
            ...
            <div class="order-page-1-col-2 kit_box kit_box_essentials ">
                ...
                <div class="">
                    <a href="#" class="prodlink"><img src="//d39hwjxo88pg52.cloudfront.net/volaire/images/e2/selector-essentials.jpg" class="full block" alt="Six products for amazing skin. Get a skin care system that works for you and your skin. All shades of skin will benefit." /></a>
                    <div class="benefitsbar"><%# CSBusiness.DynamicVersion.Helper.IncludeFile("benefits-txt.html")%></div>
                    <div class="order_bottom_txt">
...
<section class="container offer-footer">
    <div class="offer-footer-content">
        ...
        <div id="kit_mega_legal" class="footnotes">
            <p>*VOLAIRE Incredible Volume Collection, 90 Day Supply. WITH YOUR ORDER TODAY, YOU’LL RECEIVE A FREE FULL-SIZE BONUS GIFT, AND FREE SHIPPING! For today’s Incredible Volume Collection, 90 Day Supply, you will be charged 1 payment of $39.95, plus any applicable tax, plus two additional monthly payments of $39.95.</p>
            <p>This offer includes enrollment in the VOLAIRE MVP Subscription Program. Approximately 12 weeks after your first order is shipped, and then approximately every 12 weeks thereafter, you will be sent a new 90 Day supply of the Incredible Volume Collection. Each shipment will be charged to the card you provide today, in three installments, approximately every 4 weeks at the guaranteed low price of $39.95, per installment plus $3.33 per installment for shipping and handling, plus any applicable sales tax, unless you call to cancel. There is no commitment and no minimum to buy. Please note exact shipment times may vary.  </p>
