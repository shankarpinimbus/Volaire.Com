        ...
        <asp:PlaceHolder ID="pnlAddCategory" runat="server" Visible="False">
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="txtConfig" runat="server" TextMode="MultiLine" CssClass="textarea-large" Rows="5" />
                </td>
                <td class="span1 text-center">
