...
namespace CSWeb.Admin.UserControls
{
    ...
    public partial class DateControlReport : UserControl
    {
        ...
        /// </summary>
        public DataRangeValidationTypeReport RangeType
        {
            get
            {
                if (ViewState["DataRangeValidationType"] == null)
                { return DataRangeValidationTypeReport.Any; }
                else
                { return (DataRangeValidationTypeReport)ViewState["DataRangeValidationType"]; }
            }
        ...
        protected void rangeVal_Validate(object sender, ServerValidateEventArgs e)
        {
            ...
            {
                if (RangeType == DataRangeValidationTypeReport.Any)
                {
                    e.IsValid = true;
                }
                else if (RangeType == DataRangeValidationTypeReport.Future)
                {
                ...
                else if (RangeType == DataRangeValidationTypeReport.FutureIncludingToday)
                {
                    if (CutoffDate.HasValue)
                        e.IsValid = (ValueLocal.Value.Date >= today) && (ValueLocal.Value.Date < CutoffDate.Value.Date);
                    else
                ...
                else if (RangeType == DataRangeValidationTypeReport.Past)
                {
                    if (CutoffDate.HasValue)
                        e.IsValid = ValueLocal.Value.Date < today && ValueLocal.Value.Date > CutoffDate.Value.Date;
                    else
                ...
                else if (RangeType == DataRangeValidationTypeReport.PastIncludingToday)
                {
                    if (CutoffDate.HasValue)
                        e.IsValid = ValueLocal.Value.Date <= today && ValueLocal.Value.Date > CutoffDate.Value.Date;
                    else
    ...
    public enum DataRangeValidationTypeReport
    {
        Any,
        Past,
        PastIncludingToday,
