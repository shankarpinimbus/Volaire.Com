...
{
    public partial class RangeDateControlReport : UserControl
    {
        ...
        protected DateControlReport dateControlStart;
        protected DateControlReport dateControlEnd;
        ...
        {
            get { return ((DateControlReport)dateControlStart).TextboxWidth; }
            set { ((DateControlReport)dateControlStart).TextboxWidth = value; }
        }

        public Unit EndDateWidth
        {
            get { return ((DateControlReport)dateControlEnd).TextboxWidth; }
            set { ((DateControlReport)dateControlEnd).TextboxWidth = value; }
        }
        ...
        {
            get { return ((DateControlReport)dateControlStart).ValueLocal; }
            set { ((DateControlReport)dateControlStart).ValueLocal = value; }
        }


        public DateTime? EndDateValueLocal
        {
            get { return ((DateControlReport)dateControlEnd).ValueLocal; }
            set { ((DateControlReport)dateControlEnd).ValueLocal = value; }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ((DateControlReport)dateControlStart).IsRequired = DateRequired;
            ((DateControlReport)dateControlEnd).IsRequired = DateRequired;
            ...
            if (!Page.IsPostBack)
            {
                if (m_displayDropDown)
                {
                    ...
                    dropDownListDate.Attributes.Add("onchange", "DropDownListDateOnChange(this.options[this.selectedIndex].value, \"" + ((DateControlReport)dateControlStart).TextID + "\", \"" + ((DateControlReport)dateControlEnd).TextID + "\", \"" + ((DateControlReport)dateControlStart).ExtenderID + "\", \"" + ((DateControlReport)dateControlEnd).ExtenderID + "\")");
        ...
        private void SetSelection()
        {
            ...
            {
                ((DateControlReport)dateControlStart).ValueLocal = new DateTime(defaultStartDate.Year, defaultStartDate.Month, defaultStartDate.Day, 0, 0, 0);
                ((DateControlReport)dateControlEnd).ValueLocal = new DateTime(defaultEndDate.Year, defaultEndDate.Month, defaultEndDate.Day, 23, 59, 59);
