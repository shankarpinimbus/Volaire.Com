...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div id="page-content">
        ...
        <div class="form-horizontal form-box">
            ...
            <div class="form-box-content">
                <div class="control-group">
                    <div class="controls">
                        <label class="checkbox text-info">
                            <asp:CheckBox ID="cbRushShippingOption" runat="server" AutoPostBack="True" OnCheckedChanged="cbRushShippingOption_OnCheckedChanged"></asp:CheckBox>
                            <em><strong>Include Rush Shipping Cost</strong></em>
                        </label>
                    </div>
                </div>
                <div class="control-group">
                    <div class="controls">
                        <label class="radio">
                            <asp:RadioButton ID="cbOrderSubTotal" runat="server" AutoPostBack="true" OnCheckedChanged="OnCheckChanged_OrderVal" GroupName="ShippingItems" Text="Based on order subtotal" />
                        </label>
                    </div>
                </div>
                    ...
                    <asp:Repeater ID="rptItems" runat="server">
                        <HeaderTemplate>
                            <div class="control-group">
                                <div class="controls">
                                    <p class="text-right">
                                        <asp:LinkButton ID="lbItemAdd" runat="server" OnCommand="btnAction_Command" CommandName="AddOrderVal" CssClass="btn btn-info btn-mini"><i class="icon-plus"></i> Add New Item</asp:LinkButton></p>
                                    <table class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>Minimum Order Subtotal
                                                </th>
                                                <th>Shipping Charge
                                                </th>
                                            </tr>
                ...
                <div class="control-group">
                    <div class="controls">
                        <label class="radio">
                            <asp:RadioButton ID="cbOrderWeight" runat="server" AutoPostBack="true" OnCheckedChanged="OnCheckChanged_Weight" GroupName="ShippingItems" Text="Based on order weight" />
                        </label>
                    </div>
                </div>
                <!--<div id="dvOption1" style="display: none; visibility: hidden;"> </div> -->
                    ...
                    <asp:Repeater ID="rptOrderWeight" runat="server">
                        <HeaderTemplate>
                            <div class="control-group">
                                <div class="controls">
                                    <p class="text-right">
                                        <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-info btn-mini" OnCommand="btnAction_Command" CommandName="OrderWeight"><i class="icon-plus"></i> Add New Item</asp:LinkButton>
                                    </p>

                                    <table class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>Minimum Order Weight
                                                </th>
                                                <th>Shipping Charge
                                                </th>
                                            </tr>
                ...
                <div class="control-group">
                    <div class="controls">
                        <label class="radio">
                            <asp:RadioButton ID="cbSkuItem" runat="server" AutoPostBack="true" Text="Based on item" OnCheckedChanged="OnCheckChanged_Sku" GroupName="ShippingItems" /></label>
                    </div>
                </div>
                ...
                <div class="control-group">
                    <div class="controls">
                        <label class="radio">
                            <asp:RadioButton ID="cbFlat" runat="server" AutoPostBack="true" OnCheckedChanged="OnCheckChanged_Flat" GroupName="ShippingItems" Text="Flat Shipping Rate" />
                        </label>
                    </div>
                </div>
                    ...
                    <div class="form-horizontal form-box">
                        ...
                        <div class="form-box-content">
                            <div class="control-group">
                                <div class="controls">
                                    <label class="radio">
                                        <asp:RadioButton ID="cbRushOrderTotal" runat="server" AutoPostBack="true" Text="Based on the order subtotal" OnCheckedChanged="OnCheckChanged_RushOrderVal" GroupName="RushShippingItems" /></label>
                                </div>
                            </div>
                            <!--<div id="dvOption1" style="display: none; visibility: hidden;"> </div> -->
                                ...
                                <asp:Repeater ID="rptRushOrderTotal" runat="server">
                                    <HeaderTemplate>
                                        <div class="control-group">
                                            <div class="controls">
                                                <p class="text-right">
                                                    <asp:LinkButton ID="lbRushItemAdd" runat="server" CssClass="btn btn-mini btn-info" OnCommand="btnRushAction_Command" CommandName="AddRushOrderVal"><i class="icon-plus"></i> Add New Item</asp:LinkButton>
                                                </p>
                                                <table class="table table-bordered table-striped">
                                                    <thead>
                                                        <tr>
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    <label class="radio">
                                        <asp:RadioButton ID="cbRushOrderweight" runat="server" AutoPostBack="true" Text="Based on order weight" OnCheckedChanged="OnCheckChanged_RushWeight" GroupName="RushShippingItems" />
                                    </label>
                                </div>
                            </div>
                                ...
                                <asp:Repeater ID="rptRushOrderWeight" runat="server">
                                    <HeaderTemplate>
                                        <div class="control-group">
                                            <div class="controls">
                                                <p class="text-right">
                                                    <asp:LinkButton ID="lbRushWeightItemAdd" runat="server" CssClass="btn btn-mini btn-info" OnCommand="btnRushAction_Command" CommandName="RushOrderWeight"><i class="icon-plus"></i> Add New Item</asp:LinkButton></p>
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    <label class="radio">
                                        <asp:RadioButton ID="cbRushSkuItem" runat="server" AutoPostBack="true" Text="Based on item" OnCheckedChanged="OnCheckChanged_RushSku" GroupName="RushShippingItems" /></label>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    <label class="radio">
                                        <asp:RadioButton ID="cbRushFlat" runat="server" AutoPostBack="true" Text="Flat Shipping Rate" OnCheckedChanged="OnCheckChanged_RushFlat" GroupName="RushShippingItems" />
                                    </label>
                                </div>
                            </div>
                        ...
                        <asp:Repeater ID="rptShippingCharges" runat="server">
                            <HeaderTemplate>
                                <div class="control-group">
                                    <div class="controls">
                                        <p class="text-right">
                                            <asp:LinkButton ID="lbAddShippingCharge" runat="server" CssClass="btn btn-mini btn-info" OnCommand="lbAddShippingCharge_Command" CommandName="AddShippingCharge"><i class="icon-plus"></i> Add New Shipping Charge</asp:LinkButton>
                                        </p>
                                        <table class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="span1 text-center">Delete
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        ...
                                        <asp:TextBox ID="txtKey" runat="server" CssClass="input-medium" MaxLength="32" Text='<%# DataBinder.Eval(Container.DataItem, "Key") %>' />
                                    </td>
                                    <td>$
        ...
        <p>
            ...
            <asp:LinkButton runat="server" ID="btnSave" CommandName="Save" CssClass="btn btn-success" OnCommand="btnSave_Command" ValidationGroup="valError"><i class="icon-save"></i> Save</asp:LinkButton>
        </p>
    </div>
</asp:Content>
