<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StandardReport.aspx.cs" Inherits="CSWeb.Admin.StandardReport"  EnableViewState="true" EnableSessionState="true" EnableEventValidation="false" %>
...
padding: 9px 0 3px 0;
        ...
        {
            float: left;
            background: #e7e7e7 url(//d39hwjxo88pg52.cloudfront.net/images/admin/rep_bg2.jpg) no-repeat 176px 158px;
        ...
        #header
        {
            background: url(//d39hwjxo88pg52.cloudfront.net/images/admin/rep_mainhd2.jpg) no-repeat;
            width: 921px;
            height: 125px;
        }
        #hd_date
        ...
        #hd_client
        {
            background: url(//d39hwjxo88pg52.cloudfront.net/images/admin/rep_hdclient.jpg) no-repeat;
        }
        #hd_resource
        {
            background: url(//d39hwjxo88pg52.cloudfront.net/images/admin/rep_hdresource.jpg) no-repeat;
        }
        #hd_activity
        {
            background: url(//d39hwjxo88pg52.cloudfront.net/images/admin/rep_hdactivity.jpg) no-repeat;
        }
        #hd_summary
        {
            background: url(//d39hwjxo88pg52.cloudfront.net/images/admin/rep_hdsummary.jpg) no-repeat;
        }
        #hd_wksummary
        {
            background: url(//d39hwjxo88pg52.cloudfront.net/images/admin/rep_hdwksummary.jpg) no-repeat;
        }
        #hd_mosummary
        {
            background: url(//d39hwjxo88pg52.cloudfront.net/images/admin/rep_hdmosummary.jpg) no-repeat;
        }
        .hd_items_sold
        {
            background: url(//d39hwjxo88pg52.cloudfront.net/images/admin/rep_hdtopitems.jpg) no-repeat;
            width: 306px;
            height: 20px;
        }
    ...
    <div id="outerwrap2">
        <div id="header2">
            ...
            <div id="report_nav">
                ...
                <span class="current">Standard Report</span> | 
        ...
        <div id="main2">
            ...
            <div id="left">
                ...
                <div id="resource">
                    <h2 id="hd_resource" class="text_replace">
                        Select Resource</h2>
                    <div class="content">
                        <img src="//d39hwjxo88pg52.cloudfront.net/images/admin/rep_lnkreports.jpg" width="144" height="29" alt="Reports" />
                        <img src="//d39hwjxo88pg52.cloudfront.net/images/admin/rep_lnkorders.jpg" width="144" height="29" alt="Orders" />
                    </div>
                </div>
                <div id="activity">
            ...
            <div id="right2" class="col_b">
                <div id="stats_day">
                    <div id="summary">
                        <h3 id="hd_summary" class="text_replace">
                            Summary</h3>
                        <div class="content">
                    ...
                    <div id="items_sold">
                        <h3 class="hd_items_sold text_replace">
                            Items Sold</h3>
                        <div class="content">
                            <table cellpadding="0" cellspacing="0">
