...
namespace CSWeb.Admin
{
    public partial class StandardReport : BasePage
    {
        ...
        {         
            ...
            if(!OrderHelper.IsReportEST())//PST            
            {
                dte1 = rangeDateControlCriteria.StartDateValueLocal;
                dte2 = DateTimeUtil.GetEndDate(rangeDateControlCriteria.EndDateValueLocal);
