...
<section class="hero hero-90-day-kit">
    <div class="container">
        ...
        <h1>
            Upgrade, 
            <span class="part2"><span class="webfont1 ital uncaps">go big!</span></span>
        </h1>
    </div>
</section>
...
<section class="container offer-footer">
    <div class="offer-footer-content">
        ...
        <p>*Mega Volume Collection, 90 Day Supply. WITH YOUR ORDER TODAY, YOU’LL RECEIVE A FREE FULL-SIZE BONUS GIFT, AND FREE SHIPPING! For today’s Mega Volume Collection, 90 Day Supply, you will be charged 1 payment of $29.95, plus any applicable tax, plus two additional monthly payments of $29.95.</p>
        <p>This offer includes enrollment in the VOLAIRE MVP Subscription Program. Approximately 12 weeks after your first order is shipped, and then approximately every 12 weeks thereafter, you will be sent a new 90 Day supply of the Shine to the Max Collection. Each shipment will be charged to the card you provide today, in three installments, approximately every 4 weeks at the guaranteed low price of $29.95, per installment plus $3.33 per installment for shipping and handling, plus any applicable sales tax, unless you call to cancel. There is no commitment and no minimum to buy. Please note exact shipment times may vary.  </p>
