...
-- set object name
select @ObjectId = (select objectid from objects where name = 'SitePref')

-- set attribute name
set @AttributeName = 'QtyInWeightBasedShipping'

-- set object attribute desc
set @ObjectAttributeDesc = 'QtyInWeightBasedShipping.'
